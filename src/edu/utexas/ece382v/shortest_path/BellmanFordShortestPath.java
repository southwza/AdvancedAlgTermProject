...
public class BellmanFordShortestPath {
    ...
    public Double calculateShortestPath(Graph g, Node source, Node target) {
        return calculateShortestPath(g, source, target, false, Runtime.getRuntime().availableProcessors());
    }
     ...
     * @return
     */
    public Double calculateShortestPath(Graph g, Node source, Node target, boolean printStats, int threads) {
        ...
        Map<Node, Edge> req; //Nodes to be relaxed to the given value
